...
import com.example.myapp.util.AnimationUtil;
 ...
 */
public class IOSBottomDialogFragment extends DialogFragment {

    private View rootView;
    private ButtomDialogListener mListener;
    private String[] items;

    public static IOSBottomDialogFragment newInstance(String[] items, ButtomDialogListener mListener) {
        IOSBottomDialogFragment fragment = new IOSBottomDialogFragment();
    ...
    public View onCreateView(LayoutInflater inflater,  ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.dialog_bottom_layout, container, false);
...
//                }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        listView.setAdapter(new ArrayAdapter(getActivity(), R.layout.dialog_bottom_item, R.id.tv_item, items));
