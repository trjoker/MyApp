...
public class BottomBar extends View {
    ...
    public BottomBar setTitleBeforeAndAfterColor(String beforeResCode, String AfterResCode) {
        //支持"#333333"这种形式
    ...
    public BottomBar addItem(Fragment fragment, String title, int iconResBefore, int iconResAfter) {
    ...
    private void initParam() {
        if (itemCount != 0) {
            ...
            //图标文字margin
            int textIconMargin = dp2px(((float) titleIconMargin) / 2);//先指定5dp，这里除以一半才是正常的margin
            // ，不知道为啥，可能是图片的原因

            //标题高度
            int titleSize = ConvertUtils.sp2px(titleSizeInDp);//这里先指定10dp
