...
public class DateUtil {
     ...
     * @return
     */
    public static String getDateFormatForLetter(String getDateString, Context context) {
    ...
    public static String getTimeStringDisplay(String getDateString) {
        ...
        if (getDate.getDate() < formatSysDate.getDate()) {
            final SimpleDateFormat simpleDateFormat = new SimpleDateFormat(DATE_FORMAT_10);
            return simpleDateFormat.format(getDate);
        } else {
            // 判断当前总天数
    ...
    public static long getIntervalMinutes(String startTime, String endTime) {
        if (!TextUtils.isEmpty(startTime) && !TextUtils.isEmpty(endTime)) {
            try {
                ...
                {/*
                  * // 相差小时 long diffHours = diff / (60 * 60 * 1000); System.out.println("Difference in hours " +
                  * diffHours);
                  * 
                  * // 相差天 long diffDays = diff / (24 * 60 * 60 * 1000);
                  */
                }
     ...
     * @author Administrator
     */
    public static String getDaysBetweenForContainWeek(TextView start, TextView end) {
        return getDaysBetween(getDateNoWeek((start.getText().toString())), getDateNoWeek((end.getText().toString())))
                + "天";
    }
